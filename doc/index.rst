...
In this example we use a public Firefly server. Open a web browser to
`http://irsa.ipac.caltech.edu:80/irsaviewer <http://irsa.ipac.caltech.edu:80/irsaviewer>`_.
